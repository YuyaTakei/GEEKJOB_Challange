...
public class InsertResult extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String name =(String) userbeans.getName();
            userdata.setName((String) userbeans.getName());
            
            String year = (String) userbeans.getYear();
            String month = (String) userbeans.getMonth();
            String day = (String) userbeans.getDay();
            Date birthday = sdf.parse(year + "-" + month + "-" + day);
            userdata.setBirthday(birthday);
            
            userdata.setType((Integer) userbeans.getType());
